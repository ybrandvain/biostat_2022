...
The raw data are available here if you want to follow along.   <span style="color: LightGrey;">Before we analyze it, I am confessing to changing it for teaching purposes. Specifically I am taking the first data point and saying it came from a mating between a UK female and a swiss male.</span>
