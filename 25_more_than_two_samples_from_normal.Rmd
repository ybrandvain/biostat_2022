...
```{r, fig.height=1.97, fig.width=3.5, fig.show='hold', message=FALSE, warning=FALSE}
...
Figure \@ref(fig:varpart), really helps me understand what we are doing in ANOVA -- we think about all variability in our data (**a**) as the sum of the variability among (**b**), and within groups.  To do so, we first square the length of each line in Figure \@ref(fig:varpart), and add them up. These are called the sums of squares. 
