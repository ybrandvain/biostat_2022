...
Scientists build explanatory plots to effectively communicate their results, and provide skeptical readers the opportunity to evaluate their claims. Plots are such a critical mode of scientific communication that in many lab meetings, papers are discussed by looking at the figures.  
...
*Example of telling a story:* In basketball most shots are worth two points, while distant shots beyond the 'three point' line are worth three points. In around 2008-ish the NBA started to get serous about analytics, and a bunch of mathy people figured out that three points are more valuable than two points, so teams should shoot either three pointers, or very close two point shots, that have a really good chance of going in ([podcast for the curious](https://www.npr.org/2020/09/11/911898347/the-science-of-hoops)).  
...
- What is our method of presentation -- that is, how is the audience experiencing our plots? Printed paper? A slide? A poster? The internet etc...?    
...
**As you read the guidance below, consider how would you change plots based on audience.**
...
We will focus on the distribution of student to teacher ratios across continents (first introduced in Figs \@ref(fig:evo)), as an example, but will introduce other data sets when necessary.   
...
Figure \@ref(fig:georgia) shows a graph, released by the state of Georgia in May 2020, to show that they were controlling coronavirus. Can you spot what is misleading here?
...
- **Make points obvious.** While scientific figure should tell a story, they should not be a mystery novel or *Fight Club* -- that is, the story should be obvious throughout, and the reader should get the story without needing to solve a puzzle.
...
Be carefull that you have double checked everything!!! Or you could look like this.  
