...
Staying with the `rivers` data set, let's see how we can calculate these summaries in R. As I showed with the mean, I'll first worth through example codes that shows all the steps and helps use understand what we are calculating, before showing R shortcuts.
...
So, now the we have the squared deviations, we can calculate all of our summaries of interest. But there is a bit of new R to learn.    
