...
replicate(n = 1000, simplify = FALSE, 
          expr = slice_sample(snake_data, prop = 1, replace = TRUE)%>%
...
Don't take my word for the reality of attenuation - let's simulate it!    Let's take our snake data set with an actual slope of, `round(coef(snake_lm)[2], digits = 4)`, and pretend this is a real population.   
...
And compare our estimated slope in these noisier estimates to our initial estimate of the correlation.   To do so, we ad noise to x, y, or both, then estimate the slope, and then do this a bunch. For fun, let's add a standard deviation's random noise   
